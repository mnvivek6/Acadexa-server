...
import { decline, getAllTutors, getTutorsbyName, tutorBlock, tutorbyid, unverifiedTutors, verify } from "../controller/admin/getTutors"
...
adminRoute.post('/verify/:tutorid',adminAuthToken,verify)
adminRoute.get('/decline',adminAuthToken,decline)
